        ...
        <div className='mb-[120px]'>
            ...
            <div className='grid lg:grid-cols-3'>
                <div className='flex justify-items-center lg:mb-[78px]'>
                    <div><img src={icon2} alt="" className=''/></div>
                    <div className='w-[261px] h-[94px] mx-6'>
                ...
                <div className='flex justify-items-center'>
                    <div><img src={icon3} alt="" className=''/></div>
                    <div className='w-[261px] h-[94px] mx-6'>
                ...
                <div className='flex justify-items-center'>
                    <div><img src={icon5} alt="" className=''/></div>
                    <div className='w-[261px] h-[94px] mx-6'>
                ...
                <div className='flex justify-items-center'>
                    <div><img src={icon1} alt="" className=' '/></div>
                    <div className='w-[261px] h-[94px] mx-6'>
                ...
                <div className='flex justify-items-center'>
                    <div><img src={icon4} alt="" className=' '/></div>
                    <div className='w-[261px] h-[94px] mx-6'>
                ...
                <div className='flex justify-items-center'>
                    <div><img src={icon6} alt="" className=''/></div>
                    <div className='w-[261px] h-[94px] mx-6'>
